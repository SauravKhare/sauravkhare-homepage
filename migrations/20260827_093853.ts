...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "archives_records" ADD COLUMN "index" varchar NOT NULL;
  ALTER TABLE "archives_records" ADD COLUMN "label" varchar NOT NULL;
  ALTER TABLE "archives_records" ADD COLUMN "year" varchar NOT NULL;
  ALTER TABLE "archives_records" ADD COLUMN "description" varchar NOT NULL;
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "archives_records" ADD COLUMN "version" varchar NOT NULL;
  ALTER TABLE "archives_records" ADD COLUMN "year_range" varchar NOT NULL;
