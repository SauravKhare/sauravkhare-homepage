...
export default async function HeaderTopNavigation() {
  ...
  return (
    <header className="bg-dark-primary text-light-primary border-b border-light-primary/10">
      <div className="px-6 md:px-16 py-6 md:max-w-360 md:mx-auto flex justify-between items-center">
        <div className="font-fraunces text-2xl font-bold uppercase"><Link href="/">Saurav Khare</Link></div>
        <div className="overflow-x-scroll hidden lg:block">
        ...
        <div>
          <ul className="flex font-jakarta uppercase justify-between gap-5 md:gap-9">
            <li><ThemeToggle /></li>
