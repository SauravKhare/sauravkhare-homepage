...
export default function Hero({ data }: HeaderSectionProps) {
  ...
  return (
    <Container borderBottom={true}>
      <h1 className="text-4xl md:text-8xl font-fraunces font-variation-settings-['opsz'_96]">Saurav Khare</h1>
      ...
      <Link href="#phy" className="hidden md:block text-light-primary font-jakarta mt-36 text-sm">SCROLL TO EXPLORE <span><ArrowDownwardIcon className="text-teal-primary text-xs" /></span></Link>
    </Container>
  );
}