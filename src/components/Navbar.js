...
function Navbar() {
    return (
        ...
        <nav className="nav-bar">
            ...
            <svg version="1.1" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" xmlnscc="http://creativecommons.org/ns#" xmlnsdc="http://purl.org/dc/elements/1.1/" xmlnsrdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlnsXlink="http://www.w3.org/1999/xlink">
            <metadata>
            <rdfRDF>
            <ccWork rdfabout="">
            ...
            <defs>
            <rect id="b" width="129.85" height="141.39"/>
            <rect id="a" width="129.85" height="141.39"/>
            </defs>
            <g fill="none" fillRule="evenodd">
            <circle cx="250" cy="250" r="250" fill="#000"/>
            <g transform="translate(61 180)">
            <ellipse cx="189" cy="69.973" rx="70.079" ry="69.973" fill="#00E054"/>
            <g transform="translate(248.15)">
            <mask id="d" fill="white">
            <use xlinkHref="#b"/>
            </mask>
            <ellipse cx="59.769" cy="69.973" rx="70.079" ry="69.973" fill="#40BCF4" mask="url(#d)"/>
            </g>
            <mask id="c" fill="white">
            <use xlinkHref="#a"/>
            </mask>
            <ellipse cx="70.079" cy="69.973" rx="70.079" ry="69.973" fill="#FF8000" mask="url(#c)"/>
            <path d="m129.54 107.02c-6.7288-10.744-10.618-23.443-10.618-37.049s3.8891-26.305 10.618-37.049c6.7288 10.744 10.618 23.443 10.618 37.049s-3.8891 26.305-10.618 37.049z" fill="#fff"/>
            <path d="m248.46 32.924c6.7288 10.744 10.618 23.443 10.618 37.049s-3.8891 26.305-10.618 37.049c-6.7288-10.744-10.618-23.443-10.618-37.049s3.8891-26.305 10.618-37.049z" fill="#fff"/>
            </g>
            </g>
            </svg>
